...
public class ProductDetailModel(ICatalogService catalogService,IBasketServices basketServices,ILogger<ProductDetailModel> logger)
    : PageModel
{
    ...
    public async Task<IActionResult> OnPostAddToCartAsync(Guid productId)
    {
        ...
        return RedirectToPage("CartDetail");
    }
}
